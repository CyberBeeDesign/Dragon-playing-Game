...
function buyWeapon() {
    //because weapons.length start at 1 while an index start at 0
...
function attack() {
  ...
  // Verify that you either fight the dragon or others Monsters
  if (fighting === 2) {
    winGame()
  } else {
    defeatMonster ()
  ...
  //create a chance that the player's weapon breaks but only if the inventory has 2 or more weapons
